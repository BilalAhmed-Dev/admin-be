...
#     6  cd /opt/
#     9  wget https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.99/bin/apache-tomcat-9.0.99.tar.gz
#    10  tar -xzvf apache-tomcat-9.0.99.tar.gz
#    11  mv apache-tomcat-9.0.99 tomcat
#    12  cd tomcat/
#    14  cd bin
#    15  ./startup.sh
#    17  cd ../../tomcat/
#    19  vi /opt/tomcat/webapps/host-manager/META-INF/context.xml
#    <!--  <Valve className="org.apache.catalina.valves.RemoteAddrValve"
#   allow="127\.\d+\.\d+\.\d+|::1|0:0:0:0:0:0:0:1" /> -->
#    20  vi /opt/tomcat/webapps/manager/META-INF/context.xml
#    <!--  <Valve className="org.apache.catalina.valves.RemoteAddrValve"
#   allow="127\.\d+\.\d+\.\d+|::1|0:0:0:0:0:0:0:1" /> -->
#    22  cd bin/
#    23  ./shutdown.sh
...
#    32  ln -s /opt/tomcat/bin/startup.sh /usr/local/bin/tomcatup
#    33  ln -s /opt/tomcat/bin/shutdown.sh /usr/local/bin/tomcatdown
#    34  echo $PATH
#    35  tomcatdown
#    37  cd /opt/tomcat/bin/
#    39  ./shutdown.sh
#    40  ./startup.sh
